...
def launch_setup(context, *args, **kwargs):
    ...
    gazebo_model_path = os.path.join(mpc_dir, "models")
    gazebo_model_path_env = os.environ.get("GAZEBO_MODEL_PATH", "")
    if gazebo_model_path_env:
        gazebo_model_path = os.pathsep.join([gazebo_model_path, gazebo_model_path_env])

    set_gazebo_model_path = SetEnvironmentVariable(
        name="GAZEBO_MODEL_PATH", value=gazebo_model_path
    )
